...
def create_video(source_video, output_folder, bound_line):
    ...
    for frame_id in range(frames_in_video):
        ...
        print(f"{frame_id}/{frames_in_video}")

    input_video.release()
    output_video.release()


def draw_turn(source, out_folder):
    ...
    create_video(source, out_folder, bound_line)


if __name__ == '__main__':
    # save_frames("D:\\48.mp4", "d:\\AI\\2023\\18.04.2023\\", 10)
    # draw_turn("D:\\48.mp4", "d:\\AI\\2023\\18.04.2023\\")
    draw_turn("D:\\44.mp4", "d:\\AI\\2023\\18.04.2023\\")
    draw_turn("D:\\10.mp4", "d:\\AI\\2023\\18.04.2023\\")
